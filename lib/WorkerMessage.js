...
var EXIT_CODE = {
        "OK":       0,  // Safely closed.
        "ERROR":    1,  // Error in worker thread.
...
WorkerMessage["prototype"]["post"]    = WorkerMessage_post;    // WorkerMessage#post(message:Any, transfer:TransferableObjectArray):void
...
function WorkerMessage_post(message,    // @arg Any
                            transfer) { // @arg TransferableObjectArray - Literal|Array|Object|Set|Map|ArrayBuffer|TypedArray|File|Blob|FileList|CanvasProxy...
    var port = _runOnWorker ? global["MESSAGE_PORT2"] : this._messageChannel["port1"];

    if (transfer && WorkerMessage["ALLOW_TRANSFERABLE_OBJECT"]) {
